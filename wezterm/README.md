...
| `assets/tokyo-night-parallax.png` | `appearance.lua` 使用的纵向重复视差背景图 |
...
最大渲染与动画帧率为 75 FPS。主题为 Catppuccin Mocha，文本单元格背景
不透明度为 0.75，并禁用 Windows 系统背景材质。背景由两层暗色和
`assets/tokyo-night-parallax.png` 组成；图片使用 0.15 视差、纵向重复、
Cover 缩放、0.38 不透明度、0.70 饱和度和 0.72 亮度。
